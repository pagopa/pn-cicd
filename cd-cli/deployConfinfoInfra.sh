...
ParamFilePath=pn-infra/runtime-infra-confinfo/pn-data-monitoring-${env_type}-cfg.json
...
ParamFilePath=pn-infra/runtime-infra-confinfo/pn-cost-saving-${env_type}-cfg.json
